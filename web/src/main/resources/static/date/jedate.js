...
;(function(window, factory) {
    ...
    var $Q = function (selector,datecontent) {
        datecontent = datecontent || document;
        return selector.nodeType ? selector : datecontent.querySelector(selector);
    };
    ...
    jet.extend(jet,{
        ...
        text : function(elem,value) {
            var innText = document.all ? "innerText" :"textdatecontent";
    ...
    jet.extend(jeDatePick.prototype,{
        ...
        renderDate : function () {
            ...
            if(jet.isObj(opts.theme)){   
                ...
                stCell+" .jedate-datecontent .yeartable td.action span,"+stCell+" .jedate-datecontent .monthtable td.action span,"+
                stCell+" .jedate-datecontent .yeartable td.action span:hover,"+stCell+" .jedate-datecontent .monthtable td.action span:hover{"+BG+";border:1px "+t.bgcolor+" solid;"+WC+";}"+stCell+" .jedate-datecontent .daystable td.action,"+stCell+" .jedate-datecontent .daystable td.action:hover,"+
                stCell+" .jedate-datecontent .daystable td.action .lunar,"+stCell+" .jedate-header,"+stCell+" .jedate-time .timeheader,"+
                ...
                stCell+" .jedate-datecontent .daystable td.other,"+stCell+" .jedate-datecontent .daystable td.other .nolunar,"+stCell+" .jedate-datecontent .daystable td.other .lunar{"+OTH+"}"+stCell+" .jedate-datecontent .daystable td.contain,"+stCell+" .jedate-datecontent .daystable td.contain:hover{background-"+OTH+"}";
        ...
        dateTemplate : function() {
            ...
            //循环时间模板
            var hmsHtml = '<div class="jedate-time">{% for(var h=0;h<timelist.length;h++){ %}<div class="timepane"><div class="timeheader">{%= timelist.length == 1 ? lang.timetxt[0]:lang.timetxt[h+1]%}</div><div class="timedatecontent">'+
            ...
            var paneHtml = '{% for(var i=0;i<pane;i++){ %}<div class="jedate-pane">'+
                ...
                '<div class="jedate-datecontent{%= i==1?" bordge":"" %}">'+YMDStr+'</div>'+
                '</div>{% } %}';   
