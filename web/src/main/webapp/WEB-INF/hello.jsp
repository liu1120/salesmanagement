...
<head>
    ...
    <link rel="stylesheet" href="../admin/css/stylesOA.css">
</head>
...
<div class="page-wrapper">
    <nav class="navbar page-header" style="padding-top: 0px">
        ...
        <a class="navbar-brand" href="#">
            <img src="../admin/imgs/logo.png" alt="logo">
        </a>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false">
                    <img src="../admin/imgs/avatar-1.png" class="avatar avatar-sm" alt="logo">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="../admin/ch_month.html" class="nav-link">
                                    <i class="icon icon-graph"></i>&nbsp;&nbsp;产品销量
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../admin/ch_person.html" class="nav-link">
                                    <i class="icon icon-graph"></i>&nbsp;&nbsp;销售员业绩
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../admin/ch_area.html" class="nav-link">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <ul class="nav-dropdown-items">
                                <li class="nav-item">
                                    <a href="../admin/ac_list.html" class="nav-link">
                                        <i class="icon icon-target"></i>&nbsp;&nbsp;促销活动
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a href="../admin/gi_list.html" class="nav-link">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="../admin/g_list.html" class="nav-link">
                                    <i class="icon icon-energy"></i> &nbsp;&nbsp;农产品列表
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="../admin/g_infoAdd.html" class="nav-link">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="../admin/r_info.html" class="nav-link">
                                    <i class="icon icon-puzzle"></i> &nbsp;&nbsp;信息管理
                                </a>
                            </li>

                            <li class="nav-item">
                                <a href="../admin/r_attence.html" class="nav-link">
                                    <i class="icon icon-puzzle"></i> &nbsp;&nbsp;考勤记录
                                </a>
                            </li>

                            <li class="nav-item">
                                <a href="../admin/r_leave.html" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="../admin/z_suggest.html" class="nav-link">
                            <i class="icon icon-grid"></i>投诉与建议
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../admin/z_consult.html" class="nav-link">
                            <i class="icon icon-grid"></i> 技术咨询
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../admin/z_notice.html" class="nav-link">
...
<script src="../admin/js/carbon.js"></script>
