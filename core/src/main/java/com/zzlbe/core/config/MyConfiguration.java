...
//    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        // 访问路径如：http://localhost:8081/Photos/d3cf0281-bb7f-40e0-ab77-406db95ccf2c.jpg
        //其中Photos表示访问的前缀。"file:E:/Files/Photos/"是文件真实的存储路径
        registry.addResourceHandler("/Photos/**").addResourceLocations("file:E:/Files/Photos/");
    }
}